...
public class ManagerWindow {
    ...
    private MenuItem addflight=new MenuItem("add Flight");
    private MenuItem deleteflight=new MenuItem("Delete Flight");
    private MenuItem deleteuser=new MenuItem("Delete User");
    private MenuItem deleteOrder=new MenuItem("Delete Order");
   ...
   EditFlightTable(flight_observableList);
    ...
    private void initFlightComboBox()
    {
        ...
        flightMap.put("FlightNum","f_id");
        flightMap.put("Company","f_com");
        flightMap.put("FlightType","f_model");
        flightMap.put("Start time","f_stime");
        flightMap.put("End time","f_etime");
        flightMap.put("Start","f_start");
        flightMap.put("End","f_dist");
        flightMap.put("Price","f_price");
        flightMap.put("TAmount","f_left");
    ...
    private void initOrderComboBox(){
        ...
        orderMap.put("OderNum","orderid");
        orderMap.put("ID card","p_id");
        orderMap.put("FlightNum","f_id");
        orderMap.put("Name","p_name");
        orderMap.put("Company","f_com");
        orderMap.put("Start","f_start");
        orderMap.put("End","f_end");
    ...
    private void Flight_Buttonevent() {
        ...
        addflight.setOnAction(event -> {
            ...
            dialog.setHeaderText("Input Info");


            ButtonType loginButtonType = new ButtonType("affirm", ButtonBar.ButtonData.OK_DONE);
            ...
            f_id.setPromptText("FlightNum");
            TextField f_com = new TextField();
            f_com.setPromptText("Company");

            TextField f_model = new TextField();
            f_model.setPromptText("FlightType");

            TextField f_stime = new TextField();
            f_stime.setPromptText("Start time");

            TextField f_etime = new TextField();
            f_etime.setPromptText("End time");

            TextField f_start = new TextField();
            f_start.setPromptText("Start");

            TextField f_dist = new TextField();
            f_dist.setPromptText("End");

            TextField f_price = new TextField();
            f_price.setPromptText("Price");

            TextField f_left = new TextField();
            f_left.setPromptText("Ticket");

            grid.add(new Label("FlightNum:"), 0, 0);
            grid.add(f_id, 1, 0);
            grid.add(new Label("Company:"), 0, 1);
            grid.add(f_com, 1, 1);
            grid.add(new Label("FlightType:"), 0, 2);
            ...
            grid.add(new Label("TAmount:"), 0, 8);
            grid.add(f_left, 1, 8);
