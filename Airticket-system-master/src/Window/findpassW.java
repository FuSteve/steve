...
public class findpassW {
    ...
    public findpassW()
    {
        ...
        finfpwStage2.setTitle("FindPassword");
                ...
                switch (m_fp.changepw(fid1.getText(),fid2.getText(),fid3.getText(),fid4.getText())){
                    case 0:
                       // System.out.print("0");
                        ...
                        break;
                    case 1:
                        Alert fp1 = new Alert(Alert.AlertType.ERROR,"passwords are not same");
                        fp1.showAndWait();
                        break;
                    case 2:
                        Alert fp2 = new Alert(Alert.AlertType.ERROR,"Wrong ID card!!!");
                        fp2.showAndWait();
                        break;
                    case 3:
                        Alert fp3 = new Alert(Alert.AlertType.ERROR,"You don't register yet!");
                        fp3.showAndWait();
                        System.out.print("3");
                        break;
                }
