...
public class UserWindow {
    ...
    private JFXComboBox<String >end;
     ...
     private MenuItem bookflight=new MenuItem("Reserve");
     private MenuItem addpsg=new MenuItem("Add passenger");
    private MenuItem deleltepsg=new MenuItem("Delete passenger");
    private MenuItem deleteorder=new MenuItem("Concede");
    ...
    public UserWindow(String user){
        ...
        UserStage.setTitle("Welcome,"+user);
  ...
  void Order_Buttonevent(){
   deleteorder.setOnAction(event -> {
     ...
     //获取 要退订的航班 剩余票数
       ...
       alert.setTitle(" ");
       alert.setHeaderText("");
       alert.setContentText("Concede successfully!");
  ...
  void PSG_Buttonevent(){
        ...
        addpsg.setOnAction(event -> {
            ...
            dialog.setTitle("Add passenger's info");
            dialog.setHeaderText("Input passenger's info");
            ...
            pid.setPromptText("ID card");



            grid.add(new Label("passenger's name:"), 0, 0);
            grid.add(name, 1, 0);
            grid.add(new Label("passenger's ID:"), 0, 1);
            grid.add(pid, 1, 1);
    ...
    button_ModifyPsw.setOnAction(event -> {
        ...
        if(  passwd.equals(OriginPwd.getText() ) ){
            ...
            if( NowPwd.getText().equals(ConfirmPwd.getText())) {
                ...
                alert.setTitle(" ");
                alert.setHeaderText("");
                alert.setContentText("update password successful");
           ...
           alert.setTitle("");
            alert.setHeaderText("");
            alert.setContentText("the original password wrong");
