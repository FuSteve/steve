        ...
        b_re.setOnAction(event ->
        {
            //System.out.print(tf6.getText()+" "+tf5.getText()+ " "+tf4.getText());
              ...
              //  m_re.getConnection();
                ...
                if(rb2.isSelected()){sex="female";//System.out.print("nv");
                }
                ...
                try {
                    switch (m_re.re_user(tf1.getText(), tf2.getText(), tf3.getText(),tf4.getText(),sex,tf6.getText(),agree)) {
                        case 0:
                            //请认真阅读声明条款
                            //System.out.print("0");
                            Alert rcw0 = new Alert(Alert.AlertType.WARNING,"please read these rules");
                            rcw0.showAndWait();
                            break;
                        case 1:
                            //用户名被使用
                           // System.out.print("1");
                            Alert rcw1 = new Alert(Alert.AlertType.WARNING,"user already exist");
                            rcw1.showAndWait();
                            break;
                        case 2:
                            //密码不一致
                            //System.out.print("2");
                            Alert rcw2 = new Alert(Alert.AlertType.WARNING,"please input the same password");
                            rcw2.showAndWait();
                            break;
                        case 3:
                            //注册成功
